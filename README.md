...
![Главный экран камеры — режим Фото](assets/examples/ui/camera-photo-mode.jpg)
...
- **Меню** (три полоски справа вверху) — настройки, таймер, сетка

![Меню настроек камеры](assets/examples/ui/camera-settings-menu.jpg)
...
![Дополнительные режимы камеры](assets/examples/ui/camera-more-modes.jpg)
...
![Режим Ночь](assets/examples/ui/camera-night-mode.jpg)
...
![Режим Видео — выбор разрешения](assets/examples/ui/camera-video-mode.jpg)
...
![Google Photos — кнопка Edit](assets/examples/ui/google-photos-edit-menu.jpg)

![Google Photos — панель Adjust](assets/examples/ui/google-photos-adjust-tools.jpg)
...
![Pro mode — ручные контролы WB/F/S/ISO/EV/LENS](assets/examples/ui/camera-pro-mode.jpg)
...
![Режим 200MP / Ultra HD](assets/examples/ui/camera-200mp-mode.jpg)
